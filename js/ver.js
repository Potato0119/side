...
function select() {
  ...
  if (obj == 1) {
    ...
    document.getElementById("sel_t2").textContent =
      '放上專案:"我的AQI","猜幾A幾B"';
    document.getElementById("sel_t3").textContent = "\xa0";
    document.getElementById("sel_t4").textContent = "\xa0";
    document.getElementById("sel_t5").textContent = "\xa0";
  ...
  if (obj == 3) {
    ...
    document.getElementById("sel_t1").textContent =
      '更新"關於我" 新增Python,Java等學習資源';
    document.getElementById("sel_t2").textContent = "\xa0";
    document.getElementById("sel_t3").textContent = "\xa0";
    document.getElementById("sel_t4").textContent = "\xa0";
    document.getElementById("sel_t5").textContent = "\xa0";
  ...
  if (obj == 5) {
    ...
    document.getElementById("sel_t2").textContent =
      "在Python,Java學習資源上面加上hover特效";
    document.getElementById("sel_t3").textContent =
      "在專案上新增動畫,滑鼠靠近就會有放大縮小的動畫";
    document.getElementById("sel_t4").textContent = "\xa0";
    document.getElementById("sel_t5").textContent = "\xa0";
    document.getElementById("sel_t6").textContent = "\xa0";
  }
  ...
  if (obj == 8) {
    ...
    document.getElementById("sel_t3").textContent =
      "增加更多文字,使瀏覽體驗更佳";
    document.getElementById("sel_t4").textContent =
      "因本人更換FB,所以更改網址連結";
    document.getElementById("sel_t5").textContent = "\xa0";
  ...
  if (obj == 16) {
    ...
    document.getElementById("sel_t3").textContent =
      "刪除捲動條(僅針對Chrome跟Safari)";
    document.getElementById("sel_t4").textContent =
      '刪除"我們米老鼠 是這樣被你們欺負的嗎"的影片連結';
    document.getElementById("sel_t5").textContent = "\xa0";
    document.getElementById("sel_t6").textContent = "更新時間: 2022/7/29";
  }
  if (obj == 17) {
  ...
  if (obj == 18) {
    ...
    document.getElementById("sel_t4").textContent =
      "(笑死三個月沒更新了 我對不起社會大眾對我的期待)";
    document.getElementById("sel_t5").textContent =
      "(雖然不會有人對我有期待就是了)";
    document.getElementById("sel_t6").textContent = "\xa0";
  }
  if (obj == 19) {
  ...
  if (obj == 24) {
    ...
    document.getElementById("sel_t5").textContent = "\xa0";
    document.getElementById("sel_t6").textContent =
